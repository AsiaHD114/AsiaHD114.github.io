---
title: LovelyPhoto
date: 2026-09-26 13:11:00
comments: false
---

<!--
  ===========================================================================
  LovelyPhoto —— 相册详情页（相册总览在 /album/）
  ===========================================================================
  文件位置 source/album/lovelyphoto/index.md → 网址 /album/lovelyphoto/
  ...
  ── 放照片只要两步 --------------------------------------------------------------
    ① 图片放进 source/img/album/lovelyphoto/（建议 WebP，单张 200~400 KB 以内）
...
<!--
  ...
  它让本页首屏换成 LovelyPhoto 的封面渐变 —— restyle.css ㉞ 里
  :has(#album-lovelyphoto) 那几条规则认的就是它。删了就退回主题默认的浅粉底。
  这张是浅粉底，所以首屏文字在 ㉞ 里单独翻成了深玫红。
-->
<span id="album-lovelyphoto" hidden></span>
...
<div class="album-card-tags album-detail-tags"><span>#日常</span><span>#可爱</span></div>
...
<div class="album-wall">
<img src="/img/album/lovelyphoto/01.webp" alt="">
<img src="/img/album/lovelyphoto/02.webp" alt="">
</div>
