...
<!--
  ===========================================================================
  GameTime！ —— 相册详情页（相册总览在 /album/）
  ===========================================================================
  文件位置 source/album/gametime/index.md → 网址 /album/gametime/
  ...
  ── 放照片只要两步 --------------------------------------------------------------
    ① 图片放进 source/img/album/gametime/（建议 WebP，单张 200~400 KB 以内）
...
<!--
  ...
  它让本页首屏换成 GameTime！ 的封面渐变 —— restyle.css ㉞ 里
  :has(#album-gametime) 那几条规则认的就是它。删了就退回主题默认的浅粉底。
-->
<span id="album-gametime" hidden></span>
...
<div class="album-card-tags album-detail-tags"><span>#游戏</span><span>#截图</span></div>
...
<div class="album-wall">
<img src="/img/album/gametime/01.webp" alt="">
<img src="/img/album/gametime/02.webp" alt="">
</div>
